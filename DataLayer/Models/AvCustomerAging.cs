...
[Keyless]
public partial class AvCustomerAging
{
    [Column("DCLink")]
    ...
    [Column("UADebits")]
    public double? Uadebits { get; set; }

    [Column("UACredits")]
    public double? Uacredits { get; set; }

    [Column("FCAge1")]
    public double? Fcage1 { get; set; }

    [Column("FCAge2")]
    public double? Fcage2 { get; set; }

    [Column("FCAge3")]
    public double? Fcage3 { get; set; }

    [Column("FCAge4")]
    public double? Fcage4 { get; set; }

    [Column("FCAge5")]
    public double? Fcage5 { get; set; }

    [Column("FCAge6")]
    public double? Fcage6 { get; set; }

    [Column("FCAge7")]
    public double? Fcage7 { get; set; }

    public double? AccountBalanceForeign { get; set; }

    [Column("UADebitsForeign")]
    public double? UadebitsForeign { get; set; }

    [Column("UACreditsForeign")]
    public double? UacreditsForeign { get; set; }
}
