...
[Keyless]
public partial class BvBomcompStock
{
    ...
    public int? GroupStockPrompt { get; set; }

    public int? GroupStockVarianceAccount { get; set; }

    public int? GroupStockVariancePrompt { get; set; }

    [Column("GroupWIPAccount")]
    public int? GroupWipaccount { get; set; }

    [Column("GroupWIPPrompt")]
    public int? GroupWipprompt { get; set; }
}
