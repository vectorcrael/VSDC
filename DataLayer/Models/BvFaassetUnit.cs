...
[Keyless]
public partial class BvFaassetUnit
{
    [Column("idAssetNo")]
    ...
    [StringLength(19)]
    [Unicode(false)]
    public string BookBasisDesc { get; set; } = null!;

    public double? BookPercentage { get; set; }

    public int? UnitsOfUsage { get; set; }
    ...
    [StringLength(19)]
    [Unicode(false)]
    public string TaxBasisDesc { get; set; } = null!;
    ...
    [StringLength(8)]
    [Unicode(false)]
    public string SellScrapAssetDesc { get; set; } = null!;

    [StringLength(13)]
    [Unicode(false)]
    public string SellScrapGroup { get; set; } = null!;
    ...
    [StringLength(80)]
    [Unicode(false)]
    public string? MasterAssetDesc { get; set; }
    ...
    [StringLength(80)]
    [Unicode(false)]
    public string? UBarcode { get; set; }

    [Column("uLocationNo")]
    public int? ULocationNo { get; set; }

    [Column("uLocationCode")]
    [StringLength(30)]
    [Unicode(false)]
    public string? ULocationCode { get; set; }

    [Column("uLocationDesc")]
    [StringLength(80)]
    [Unicode(false)]
    public string? ULocationDesc { get; set; }
}
