...
[Keyless]
public partial class BvFacapexCashFlow
{
    ...
    public int Period1Amount { get; set; }

    public int Period2Amount { get; set; }

    public int Period3Amount { get; set; }

    public int Period4Amount { get; set; }

    public int Period5Amount { get; set; }

    public int Period6Amount { get; set; }

    public int Period7Amount { get; set; }

    public int Period8Amount { get; set; }

    public int Period9Amount { get; set; }

    public int Period10Amount { get; set; }

    public int Period11Amount { get; set; }

    public int Period12mount { get; set; }
}
