...
[Keyless]
public partial class BvInvNumArfull
{
    ...
    public double? InvTotInclEffective { get; set; }
    ...
    [Column("CustomerAgentID")]
    public int? CustomerAgentId { get; set; }

    [Column("INVNUMAgentID")]
    public int? InvnumagentId { get; set; }
    ...
    [StringLength(25)]
    [Unicode(false)]
    public string? ProspectFax { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPhy1 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPhy2 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPhy3 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPhy4 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPhy5 { get; set; }

    [Column("ProspectPhyPC")]
    [StringLength(15)]
    [Unicode(false)]
    public string? ProspectPhyPc { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPost1 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPost2 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPost3 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPost4 { get; set; }

    [StringLength(40)]
    [Unicode(false)]
    public string? ProspectPost5 { get; set; }

    [Column("ProspectPostPC")]
    [StringLength(15)]
    [Unicode(false)]
    public string? ProspectPostPc { get; set; }
    ...
    public bool? ProspectChargeTax { get; set; }
