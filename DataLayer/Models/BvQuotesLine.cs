...
[Keyless]
public partial class BvQuotesLine
{
    ...
    public double? QuoteStockingQty { get; set; }

    public double? QuoteQtyToProcessLineTotExcl { get; set; }
    ...
    [StringLength(20)]
    [Unicode(false)]
    public string? LineRepCode { get; set; }

    [StringLength(30)]
    [Unicode(false)]
    public string? LineRepName { get; set; }

    [StringLength(21)]
    [Unicode(false)]
    public string? LineProjectCode { get; set; }
    ...
    [StringLength(400)]
    [Unicode(false)]
    public string? AllModuleItemCode { get; set; }
}
