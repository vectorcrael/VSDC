...
[Keyless]
public partial class BvRecurrTransFullWithTx
{
    ...
    public double? FirstTxAmount { get; set; }

    public double? FirstTxAmountForeign { get; set; }

    [Column(TypeName = "smalldatetime")]
    public DateTime? LastTxDate { get; set; }

    public double? LastTxAmount { get; set; }

    public double? LastTxAmountForeign { get; set; }
}
