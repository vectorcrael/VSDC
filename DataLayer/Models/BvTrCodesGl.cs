...
[Keyless]
public partial class BvTrCodesGl
{
    [Column("idTrCodes")]
    ...
    [Column("DtTaxGroupID")]
    public int? DtTaxGroupId { get; set; }

    [StringLength(50)]
    [Unicode(false)]
    public string? DtTaxGroupCode { get; set; }

    [StringLength(120)]
    [Unicode(false)]
    public string? DtTaxGroupDescription { get; set; }

    [Column("CtTaxGroupID")]
    public int? CtTaxGroupId { get; set; }

    [StringLength(50)]
    [Unicode(false)]
    public string? CtTaxGroupCode { get; set; }

    [StringLength(120)]
    [Unicode(false)]
    public string? CtTaxGroupDescription { get; set; }
}
