...
[Keyless]
public partial class BvTrCodesJc
{
    [Column("idJobTxTp")]
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string? SellingTaxGroupCode { get; set; }

    [StringLength(120)]
    [Unicode(false)]
    public string? SellingTaxGroupDescription { get; set; }

    [StringLength(50)]
    [Unicode(false)]
    public string? CostTaxGroupCode { get; set; }

    [StringLength(120)]
    [Unicode(false)]
    public string? CostTaxGroupDescription { get; set; }
}
