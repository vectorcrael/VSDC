...
public class DataService(AppDbContext context) : IDataService
{
    ...
    public async Task<int> SetDeviceInitsAsync(DeviceInit deviceInit)
    {
        var parameters = new[]
        {
            ...
            new SqlParameter("@bsnsActv", String.IsNullOrWhiteSpace(deviceInit.BsnsActv) ? deviceInit.BsnsActv : DBNull.Value),
            ...
            new SqlParameter("@dstrtNm", String.IsNullOrWhiteSpace(deviceInit.DstrtNm) ? deviceInit.DstrtNm : DBNull.Value),
            ...
            new SqlParameter("@mrcNo", deviceInit.MrcNo.Trim()),
