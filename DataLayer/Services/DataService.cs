...
public class DataService(AppDbContext context) : IDataService
{
    ...
    public async Task<int> SetDeviceInitsAsync(DeviceInit deviceInit)
    {
        var parameters = new[]
        {
            ...
            new SqlParameter("@bsnsActv", String.IsNullOrWhiteSpace(deviceInit.BsnsActv) ? DBNull.Value : deviceInit.BsnsActv ),
            ...
            new SqlParameter("@dstrtNm", String.IsNullOrWhiteSpace(deviceInit.DstrtNm) ? DBNull.Value : deviceInit.DstrtNm),
