...
namespace DataLayer.Services
{
    public interface IFiscalInfoService
    {
        ...
        Task UpdateFiscalDetailsAsync(string signature, string internalData, string invoiceNumber, string invoiceType, string invoiceSequence, string qrCode, string vsdcDate);
    }
}
