...
CREATE TABLE [dbo].[DeviceInit](
	[resultCd] [varchar](3) NULL,
	[resultMsg] [varchar](max) NULL,
	[resultDt] [varchar](14) NULL,
	[tpin] [varchar](10) NULL,
	[taxprNm] [varchar](255) NULL,
	[bsnsActv] [varchar](100) NULL,
	[bhfId] [varchar](3) NULL,
	[bhfNm] [varchar](60) NULL,
	[bhfOpenDt] [varchar](8) NULL,
	[prvncNm] [varchar](100) NULL,
	[dstrtNm] [varchar](100) NULL,
	[sctrNm] [varchar](100) NULL,
	[locDesc] [varchar](100) NULL,
	[hqYn] [varchar](1) NULL,
	[mgrNm] [varchar](60) NULL,
	[mgrTelNo] [varchar](20) NULL,
	[mgrEmail] [varchar](50) NULL,
	[sdicId] [varchar](12) NULL,
	[mrcNo] [varchar](11) NULL,
	[lastSaleInvcNo] [numeric](38, 0) NULL,
	[lastPchsInvcNo] [numeric](38, 0) NULL,
	[lastSaleRcptNo] [numeric](38, 0) NULL,
	[lastInvcNo] [numeric](38, 0) NULL,
	[lastTrainInvcNo] [numeric](38, 0) NULL,
	[lastProfrmInvcNo] [numeric](38, 0) NULL,
	[lastCopyInvcNo] [numeric](38, 0) NULL
...
DROP PROCEDURE [dbo].[UpdateDeviceDetails]
GO
...
AS
BEGIN
    IF EXISTS (SELECT 1 FROM DeviceInit WHERE sdicId = @sdicId)
    BEGIN
        UPDATE DeviceInit
        SET  
            resultCd = @resultCd,
