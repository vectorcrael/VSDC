...
public static class NewtonsoftHttpClientJsonExtensions
{
    ...
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Get, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PatchNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri, object content,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Patch, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> DeleteNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Delete, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PostNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri, object content,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Post, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PutNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri, object content,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Put, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> HeadNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri, object content,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Head, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> OptionsNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri, object content,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendNewtonsoftJsonAsync<T>(HttpMethod.Options, requestUri, content, headers,
            cancellationToken,
            serializerSettings);
    }
        ...
        JsonSerializerSettings serializerSettings)
    {
        ...
        return await response.ReadNewtonsoftJsonAsync<T>(serializerSettings, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> GetAsNewtonsoftJsonAsync(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Get, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> DeleteAsNewtonsoftJsonAsync(this HttpClient httpClient,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Delete, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> PostAsNewtonsoftJsonAsync(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Post, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> PutAsNewtonsoftJsonAsync(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Put, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> PatchAsNewtonsoftJsonAsync(this HttpClient httpClient,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Patch, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> HeadAsNewtonsoftJsonAsync(this HttpClient httpClient,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Head, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<HttpResponseMessage> OptionsAsNewtonsoftJsonAsync(this HttpClient httpClient,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendAsNewtonsoftJsonAsync(HttpMethod.Options, requestUri, content, headers, cancellationToken,
            serializerSettings);
    }
    ...
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Get, requestUri, httpContent, headers,
    ...
    public static Task<T> DeleteFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Delete, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> PostFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Post, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> PutFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Put, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> PatchFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Patch, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> HeadFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Head, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> OptionsFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default, JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Options, requestUri, httpContent, headers,
            cancellationToken, serializerSettings);
    }
    ...
    public static Task<T> GetFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Get, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> DeleteFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Delete, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PostFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Post, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PutFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Put, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> PatchFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Patch, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> HeadFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Head, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    public static Task<T> OptionsFromNewtonsoftJsonAsync<T>(this HttpClient httpClient, string requestUri,
        ...
        JsonSerializerSettings serializerSettings = null)
    {
        return httpClient.SendFromNewtonsoftJsonAsync<T>(HttpMethod.Options, requestUri, headers, cancellationToken,
            serializerSettings);
    }
    ...
    {
        return httpClient.SendAsync(HttpMethod.Get, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> PostAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Post, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> PutAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Put, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> PatchAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Patch, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> DeleteAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Delete, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> HeadAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Head, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> OptionsAsync(this HttpClient httpClient, string requestUri,
        ...
        CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Options, requestUri, httpContent, headers, cancellationToken);
    }
    ...
    public static Task<HttpResponseMessage> GetAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Get, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> PostAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Post, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> PutAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Put, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> PatchAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Patch, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> DeleteAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Delete, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> HeadAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Head, requestUri, headers, cancellationToken);
    }

    public static Task<HttpResponseMessage> OptionsAsync(this HttpClient httpClient, string requestUri,
        Dictionary<string, string>? headers = null, CancellationToken cancellationToken = default)
    {
        return httpClient.SendAsync(HttpMethod.Options, requestUri, headers, cancellationToken);
    }
...
public class UnexpectedStatusCodeResponse
{
    public UnexpectedStatusCodeResponse(HttpResponseMessage response)
    {
        ...
        if (response.Content != null!) Body = response.Content.ReadAsStringAsync().Result; // Consider async handling
    }
