...
public static class DataMapper
{
    ...
    public static SavePurchasesRequest ConvertPurchase(ZraPurchase purchase)
    {
        return new SavePurchasesRequest
        {
            tpin = DeviceDetails.Tpin,
            bhfId = DeviceDetails.BhfId,
            invcNo = String.IsNullOrWhiteSpace( purchase.SupplierInvoiceNumber) ? null : Convert.ToInt32( purchase.SupplierInvoiceNumber) ,
            cisInvcNo = purchase.InvoiceNumber,
    ...
    {
        public static string Tpin { get; } = "1001660976";
        public static string BhfId { get; set; } = "000";
        public static string DvcSrlNo { get; set; } = "1001660976_VSDC";
