...
namespace VSDCAPI
{
    public class FiscalService(ILogger<FiscalService> logger, IFiscalInfoServiceFactory fiscalInfoServiceFactory, IVSDCAPIApiClient vSDCAPIApiClient) : IFiscalService
    {
        ...
        private readonly IFiscalInfoServiceFactory _fiscalInfoServiceFactory = fiscalInfoServiceFactory;
