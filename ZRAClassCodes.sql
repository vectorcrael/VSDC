...
CREATE TABLE [dbo].[ZRAClassCodes](
	...
	[temClsCd] [varchar](10) NULL,
	[itemClsNm] [varchar](200) NULL,
	[itemClsLvl] [numeric](18, 0) NULL,
	[taxTyCd] [varchar](5) NULL,
	[mjrTgYn] [varchar](1) NULL,
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM ZRAClassCodes WHERE temClsCd = @temClsCd)
    BEGIN
